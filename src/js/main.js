...
var app = new Vue({
  ...
  watch: {
    ...
    //   document.getElementById("editor-box").hidden = newVal !== "bind";
    //   document.getElementById("option-box").hidden = newVal !== "option";
    // },
  },
  methods: {
    runApp(path) {
...
async function editNote(id, payload) {
  // const url =
  // (await utools.readCurrentBrowserUrl()) ||
  // (await utools.readCurrentFolderPath()) ||
  // "";
